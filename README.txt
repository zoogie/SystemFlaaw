...
This game is US-only and is the first DSi exclusive cartridge title to be exploited (to my knowledge).
...
HOW:
Install - Just take the SYSTEMFLAW.0.SAV file and use TWLSaveTool on the 3DS to write it to your cart. 
